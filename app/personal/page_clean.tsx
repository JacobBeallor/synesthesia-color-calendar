    ...
    <main className="min-h-screen pb-16 bg-gray-50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <section className="mb-12 bg-white p-6 rounded-lg shadow-sm border border-gray-200">
          <h2 className="text-2xl font-bold mb-4 text-gray-900">Months</h2>
        ...
        {/* Days of Week */}
        <section className="mb-12 bg-white p-6 rounded-lg shadow-sm border border-gray-200">
          <h2 className="text-2xl font-bold mb-4 text-gray-900">Days of Week</h2>
        ...
        {/* Days of Month */}
        <section className="mb-12 bg-white p-6 rounded-lg shadow-sm border border-gray-200">
          <h2 className="text-2xl font-bold mb-4 text-gray-900">Days of Month</h2>
        ...
        {/* Color³ Days Results */}
        <section className="mb-12 bg-indigo-50 p-8 rounded-lg border-l-4 border-indigo-500">
        ...
        {!submitted ? (
          ...
          <section className="pt-8 border-t border-gray-200">
            <div className="max-w-2xl mx-auto text-center bg-green-50 p-8 rounded-lg border-l-4 border-green-500">
